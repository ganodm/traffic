...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    public static String getThumbUrl(int pos){
        return result[pos].getThumb();
    }
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            return result.length + mNumColumns;
        ...
        public Object getItem(int position) {
            return position < mNumColumns ?
                    null : getThumbUrl(position - mNumColumns);
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            mImageFetcher.loadImage(getThumbUrl(position - mNumColumns), imageView);
            return imageView;
